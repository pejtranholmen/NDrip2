...
enum class Sowing_Switch_Sw{ off,Fixed_dayNo,Temperature_Sum,Multiple_DayNo, PG_File_specified};
enum class Emergence_Switch_Sw{ off,Fixed_dayNo,Temperature_Sum,Multiple_DayNo, PG_File_specified};
