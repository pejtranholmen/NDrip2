  ...
  */
  namespace exceptions
  {
    ...
    */
    ...
    /*! 
      Thrown if the requested operation is on a nullptr group.
    ...
    /*! 
      Thrown if the requested operation is on a nullptr type.
    ...
    /*! 
      Thrown if the requested operation is on a nullptr dimension.
