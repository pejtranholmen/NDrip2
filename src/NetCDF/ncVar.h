  ...
  public:
    ...
    */
    ...
    /*!
      \overload
    */
    void setFill(bool fillMode,void* fillValue=nullptr) const;
    ...
    */
    void setFill(bool fillMode,const void* fillValue=nullptr) const;
    ...
    */
    ...
    /*!
      ...
      Must be the same type as the variable. Ignored if fillMode=.false.
    */
    void getFillModeParameters(bool& fillMode, void* fillValue=nullptr) const;
    ...
    */
    ...
    /*! 
      ...
      on. A nullptr stride argument is treated as (1, 1, ... , 1). 
    ...
    */
    ...
    /*! 
      ...
      every other element, etc.). A nullptr stride argument is treated as (1, 1, ... , 1).
    ...
    */
    ...
    /*! 
      ...
      1 and not the element's byte-length as in netCDF 2). A nullptr argument means the memory-resident values have the same structure as 
